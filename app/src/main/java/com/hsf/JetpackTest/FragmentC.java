...
import com.hsf.JetpackTest.databinding.FragmentCBinding;
...
public class FragmentC extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCBinding.inflate(getLayoutInflater(), container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.tvC.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NavController navController = Navigation.findNavController(getActivity(), R.id.my_fragment);
        ...
        binding.btnSelf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavController navController = Navigation.findNavController(getActivity(), R.id.my_fragment);
                navController.navigate(R.id.action_fragmentC_self);
            }
        });
    }
}